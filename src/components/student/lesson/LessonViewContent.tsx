                ...
                <div className="bg-slate-900/95 p-6 rounded shadow-lg w-full max-w-lg border border-slate-700/50">
                  ...
                  <div className="max-h-[70vh] overflow-y-auto pr-2">
                          ...
                          <div className="flex flex-col items-center justify-center gap-4 py-6">
                            ...
                            <div className="text-lg font-medium text-center text-slate-300">
                              {quizResult.passed ? (
                                <>
                            ...
                            <Button className="mt-2 bg-emerald-600 hover:bg-emerald-700 text-white" onClick={handleCloseQuizModal}>Fechar</Button>
                          </div>
                    ) : (
                          ...
                          {quizError && <div className="text-red-400 text-sm mb-2">{quizError}</div>}
                          <div className="flex justify-end gap-2 mt-4">
                            <Button type="button" variant="outline" className="border-slate-600 text-slate-300 hover:bg-slate-800/50" onClick={handleCloseQuizModal}>Cancelar</Button>
                            <Button type="submit" className="bg-emerald-600 hover:bg-emerald-700 text-white" disabled={quizSubmitting}>Enviar Respostas</Button>
                          </div>
                        </form>
                    )}
                  </div>

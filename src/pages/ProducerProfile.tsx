      ...
      <div className="space-y-6">
        ...
        <PageSection transparent>
          <Card className="relative overflow-hidden">
            <div className="absolute inset-0 calmon-gradient opacity-10" />
            <CardContent className="relative p-6">
              <div className="flex flex-col md:flex-row items-center md:items-start space-y-4 md:space-y-0 md:space-x-6">
                <div className="relative">
                  <Avatar className="h-24 w-24">
                    <AvatarImage src="/api/placeholder/96/96" />
                    <AvatarFallback className="text-lg calmon-gradient text-white">
                      {getUserInitials()}
                    </AvatarFallback>
                  </Avatar>
                  {isEditing && (
                    <Button
                      size="sm"
                      className="absolute -bottom-2 -right-2 h-8 w-8 rounded-full calmon-gradient text-white"
                    >
                ...
                <div className="flex-1 text-center md:text-left">
                  ...
                  <div className="flex flex-wrap gap-2 mt-3 justify-center md:justify-start">
                    <Badge className="calmon-gradient text-white border-0">Produtor</Badge>

      ...
      >
        <PageSection>
          <div className="flex flex-col items-center justify-center p-12">
            <p className="text-red-500 text-lg mb-2">Erro ao carregar dados de colaboradores.</p>
            <p className="text-gray-600 mb-4">{(error as Error)?.message || "Tente novamente mais tarde."}</p>
            <Button 
              onClick={handleRefresh}
              className="mt-4"
            >
